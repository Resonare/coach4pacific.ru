...
function showRegisterForm(){
    ...
    $('.loginBox').fadeOut('fast',function(){
        ...
        $('.modal-title').html('Давайте начнем');
        $('.modal-subtitle').html('Запишитесь на встречу с коучем');
    });
...
$(function(){
 'use strict';
$('#signup-divider').on('submit', function(e){
 e.preventDefault();
 var fd = new FormData( this );
 $.ajax({
 url: 'assets/php/send.php',
...
==========================================================================
    ...
    var light = new FSS.Light('4D80B6', '4D80B6');
